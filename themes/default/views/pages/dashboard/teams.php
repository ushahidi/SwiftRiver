<div class="container select data">
	<div class="controls edit_advanced">
		<div class="row cf">
			<p class="button-go edit_single"><a href="#">Edit team</a></p>
			<p class="button-view edit_multiple"><a href="<?php echo URL::site()?>dashboard/edit_multiple_teams">Edit multiple</a></p>
			<p class="button-view"><a href="<?php echo URL::site()?>dashboard/filter_rivers">Filter</a></p>
			<p class="button-go create_new"><a href="#">Create new</a></p>
		</div>
