...
<div class="tabs box">
	<ul>
		...
		<li <?php if ($active == 'discussions') echo 'class="ui-tabs-selected"'; ?>><a href="<?php echo URL::site('/project/'.$project_id.'/discussions');?>"><span><?php echo __('Discussions') ;?></span></a></li>
		<?php
