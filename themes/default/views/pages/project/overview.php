...
<div class="btn">
	<dl>
		...
		<dd><?php echo __('Items generated by the feeds you created');?></dd>
	</dl>
</div> <!-- /btn -->
...
<div class="btn">
	<dl>
		...
		<dd><?php echo __('Stories you\'ve created');?></dd>
	</dl>
</div> <!-- /btn -->
<div class="btn-bottom"></div>
</div> <!-- /btn-box -->
...
<div class="btn">
	<dl>
		...
		<dd><?php echo __('Feeds that generate items for the feed stream');?></dd>
	</dl>
</div> <!-- /btn -->
<div class="btn-bottom"></div>
</div> <!-- /btn-box -->
