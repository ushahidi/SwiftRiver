			...
			<article class="item cf">
				...
				<div class="summary">
					<section class="actions">
						<div class="button">
							<p class="button-change"><a class="subscribe" onclick=""><span class="icon"></span><span class="nodisplay"><?php echo __('Follow'); ?></span></a></p>
							<div class="clear"></div>
							<div class="dropdown container">
								<p><?php echo __('Are you sure you want to follow this bucket?'); ?></p>
								<ul>
