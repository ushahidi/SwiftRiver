...
/**
 * Facebook Feed Builder Controller
 *
 * PHP version 5
 ...
 */
class Controller_Project_Builder_Facebook extends Controller_Project_Builder_Main {
	...
	/**
	 * Facebook Feed Builder
	 * @return	void
	 */
	public function action_index()
	{
		$this->template->content = View::factory('facebook/builder')
			->bind('post', $post)
			->bind('errors', $errors)
			->bind('menu', $this->menu);
		...
		if ($_POST)
		{
			...
			if ($post->check())
			{
				...
				$feed->service = 'facebook';	// *** Name of the Plugin/Service
				$feed->save();
