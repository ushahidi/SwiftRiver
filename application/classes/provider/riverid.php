...
class Provider_Riverid extends Provider_OAuth {
	...
	public function verify()
	{
		...
		{
			$request = OAuth_Request::factory('resource', 'GET', 'http://id.crowdmap.com/verify_credentials.json', array(
