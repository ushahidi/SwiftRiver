...
/**
 * Swiftriver_Task_Manager test case
 *
 ...
 */
class Swiftriver_Task_Manager_Test extends Unittest_TestCase {
	
	/**
	 * @covers Swiftriver_Task_Manager::register_task
	 */
	public function test_register_task()
	{
		...
		// Swiftriver_Task_Manager::register_task('twitter', '1');
		// Swiftriver_Task_Manager::register_task('email', '1');
		
		$result = Swiftriver_Task_Manager::register_task('rss', $urls);
		$this->assertTrue($result, 'Task could not be registered');
		
		$run_result = Swiftriver_Task_Manager::run_tasks();
