		...
		<div class="center">
			<div id="page-views" class="river touchcarousel col_12">
				<ul class="touchcarousel-container">
					...
					<li class="touchcarousel-item"><a href="/markup/search/rivers.php">Rivers</a></li>
					<li class="touchcarousel-item active"><a href="/markup/search/buckets.php">Buckets</a></li>
			...
			<div class="col_12">
				<article class="container base">
					<header class="cf">
						...
						<div class="property-title">
							<h1><a href="/markup/bucket/">Ushahidi press coverage</a></h1>
						</div>
					</header>
				</article>
				...
				<article class="container base">
					<header class="cf">
						...
						<div class="property-title">
							<h1><a href="/markup/bucket/">Bucket 2</a></h1>
						</div>
					</header>
				</article>
			</div>
